module joint_detect #(
    ...
    assign cbit = is_white;
    assign circ_coun = circ_count;
    assign x_loc = col_count;
    assign y_loc = row_count;
    assign pdata = pixel;
    assign r_high = pixel[15:11] >= THRESHOLD_R;
    assign g_high = pixel[10:5] >= THRESHOLD_G;
    assign b_high = pixel[4:0] >= THRESHOLD_B;
    // Threshold to consider noise height
                ...
                // If currently tracking a segment
                    ...
                    if (!pixel_is_colour) begin
                        ...
                        if (gap_count >= MAX_GAP || pixel_col == X_COORD - 1) begin
                            ...
                            // Check MIN_WIDTH (Additional white pixel denoising)
                        ...
                        // The gap is not too large, so we continue to keep track o segment
                        else begin
    ...
    always @(*) begin
        ...
        for (i = 0; i < MAX_CIRCLES; i = i + 1) begin
            ...
            if (circles[i] && !match) begin
                // TODO: How to handle corner cases
    ...
    always @(posedge clk) begin
        if (!aresetn) begin
            ...
            // TODO: Will this be an issue for multiple frames?
